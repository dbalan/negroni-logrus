...
// NewMiddlewareWithExistingLogrus returns a new *Middleware which writes to a given logrus logger.
func NewMiddlewareWithExistingLogrus(logger *logrus.Logger, name string) *Middleware {
